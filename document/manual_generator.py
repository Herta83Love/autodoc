...
UI_TEXT = {
    "zh-TW": {
        ...
        "restrictions": "注意事項",
        "appendix": "附錄",
        "generated_notice": "本文件由 SENTRY Documentation Generator 自動產生。",
    ...
    "en": {
        ...
        "appendix": "APPENDIX",
        "generated_notice": "This document was generated by SENTRY Documentation Generator.",
...
def generate_docx(
    ...
    document.add_heading(
        text_for(language, "appendix"),
        level=1
    )

    document.add_paragraph(
        text_for(language, "generated_notice")
    )
